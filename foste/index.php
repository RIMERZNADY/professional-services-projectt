...
<html lang="en">
   ...
   <body>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="padding_left_0">
                                 <h1 class="retailer_text">Nous fournissons des conseils professionnels</h1>
                                 <p class="search_text">It is a long established fact that a reader will be distracted by the readable content of a page </p>
                                 <div class="btn_main">
                                    <div class="more_bt"><a href="about.php">En savoir plus</a></div>
                                    <div class="contact_bt"><a href="login.php">commencez</a></div>
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-6">
                           ...
                           <div class="col-md-6">
                              <div class="padding_left_0">
                                 ...
                                 <div class="btn_main">
                                    ...
                                    <div class="contact_bt"><a href="#">Obtenez un devis</a></div>
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-6">
      ...
      <div class="advisor_section">
         <div class="container">
            <h1 class="what_text">ce que nous faisons</h1>
         </div>
      </div>
               ...
               <div class="row">
                  <div class="col-lg-4 col-sm-12">
                     <div class="box_main">
                        ...
                        <h4 class="consultative_text">Consultation juridique</h4>
                        <p class="readable_text">Nous sommes dévoués à vous offrir des conseils juridiques de qualité, personnalisés pour répondre à vos besoins spécifiques. Nos experts juridiques sont là pour vous guider à travers les complexités du système juridique et vous fournir l'assistance nécessaire pour résoudre vos questions et problèmes légaux.</p>
                     </div>
                  </div>
                  <div class="col-lg-4 col-sm-12">
                     <div class="box_main active">
                        <div class="image_4 active"></div>
                        <h4 class="consultative_text active">Conseil en Affaires</h4>
                        <p class="readable_text active"> Nous vous offrons une expertise en conseil en affaires pour vous aider à prospérer dans un paysage commercial complexe et en constante évolution. Notre équipe expérimentée est prête à vous accompagner à chaque étape de votre parcours entrepreneurial.</p>
                     </div>
                  </div>
                  <div class="col-lg-4 col-sm-12">
                     <div class="box_main">
                        <div class="image_5"></div>
                        <h4 class="consultative_text">Consultation Financière</h4>
                        <p class="readable_text">Nous offrons des services de consultation financière personnalisés pour vous aider à prendre des décisions éclairées en matière de gestion financière. Notre équipe dévouée est là pour vous guider vers la sécurité financière et la croissance durable.</p>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-sm-6">
                  ...
                  <p class="lorem_text">nous sommes bien plus qu'une simple équipe de professionnels. Nous sommes des partenaires engagés dans votre succès, déterminés à offrir des services exceptionnels et une expertise approfondie dans nos domaines respectifs.</p>
                  <div class="more_bt"><a href="#">En savoir plus</a></div>
               </div>
            </div>
         </div>
