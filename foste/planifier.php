...
// crées objet service
$numeroService = $_SESSION["service"];
...
$service  = new Services($service_id, $service_name, $description, $price);
...
if(isset($_POST["submit"])){
  ...
  echo $nom, $prenom, $form_email, $phone, $date, $message;
  if(isset($nom) && isset($prenom) && isset($form_email) && isset($date) && isset($message)){
    $demmand_contact = new Demmand_contact($prenom, $nom, $form_email, $phone, $date, $message, $userId, $serviceId);
    if($demmand_contact->insertDemmand($conn)){
      ...
      <div class="contact__wrapper shadow-lg mt-n9">
        <div class="row no-gutters">
          <div class="col-lg-5 contact-info__wrapper gradient-brand-color p-5 order-lg-2">
            <h3 class="color--white mb-5">Planifier pour <?php echo $service->getServiceNom() ?></h3>
            <ul class="contact-info__list list-style--none position-relative z-index-101">
              <li class="mb-4 pl-4">
                <span class="position-absolute"><i class="fas fa-envelope"></i></span>
                <a>admin1@email.com</a>
              </li>
              <li class="mb-4 pl-4">
              ...
              <li class="mb-4 pl-4">
                ...
                Angle Bv Hassan II et<br /> Rue Yougoslavie<br /> Marrakech

                <div class="mt-3">
                  <a href="https://www.google.com/maps/place/School+Moroccan+Science+De+L'ing%C3%A9nieur/@31.6312137,-8.0127733,15z/data=!4m6!3m5!1s0xdafef9ce2003acb:0xbf12ed0e32f9fa0c!8m2!3d31.6312137!4d-8.0127733!16s%2Fg%2F11hv_1m0bq?entry=ttu" target="_blank" class="text-link link--right-icon text-white">Get directions <i class="link__icon fa fa-directions"></i></a>
                </div>
              </li>
            </ul>
          ...
          <div class="col-lg-7 contact-form__wrapper p-5 order-lg-1">
            <form action="" method="POST" class="contact-form form-validate" novalidate="novalidate">
              <div class="row">
                ...
                <div class="col-sm-12 mb-3">
                  <input type="submit" name="submit" value="planifier" class="btn btn-success" />
                </div>
              </div>
            </form>
          </div>
